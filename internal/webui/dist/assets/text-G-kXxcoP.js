import{En as e,On as t,Qt as n,Tt as r,Yt as i,en as a,ft as o,gn as s,j as c,l,pt as u,u as d,wn as f}from"./client-CHTsrZM3.js";function p(e,t){return s(()=>{for(let n of t)if(e[n]!==void 0)return e[n];return e[t[t.length-1]]})}var m=/^(\d|\.)+$/,h=/(\d|\.)+/;function g(e,{c:t=1,offset:n=0,attachPx:r=!0}={}){if(typeof e==`number`){let r=(e+n)*t;return r===0?`0`:`${r}px`}else if(typeof e==`string`)if(m.test(e)){let i=(Number(e)+n)*t;return r?i===0?`0`:`${i}px`:`${i}`}else{let r=h.exec(e);return r?e.replace(h,String((Number(r[0])+n)*t)):e}return e}function _(){let e=t(d,null);return e===null&&r(`use-message`,"No outer <n-message-provider /> founded. See prerequisite in https://www.naiveui.com/en-US/os-theme/components/message for more details. If you want to use `useMessage` outside setup, please check https://www.naiveui.com/zh-CN/os-theme/components/message#Q-&-A."),e}var v=i(`text`,`
